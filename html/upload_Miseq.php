...
<BODY>
	<form action="file_uploader_Miseq.php" method="post" enctype="multipart/form-data">
	<h3> MiSeq SampleSheet and Raw Data Processing System </h3>
	...
	<TABLE id="dataTable" width="350px" border="1">
		...
		<TR>
			...
			<th>PI_LastName</th>
                	<th>PI_FirstName</th>
			<th>ProjectID</th>
                	<th>Sequencing_Type(Primer USE)</th>
		</TR>
		</thead>
		<tbody>
		<TR>
			...
			<TD>
				<SELECT name="Sequencing_Type[]">
					...
					<OPTION value="Both">16S and ITS</OPTION>
